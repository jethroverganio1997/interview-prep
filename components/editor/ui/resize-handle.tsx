...
import {
  ...
  ResizableProvider as ResizablePrimitiveProvider,
  useResizeHandle,
...
export function Resizable({
  ...
  return (
    <ResizablePrimitive
      ...
      className={cn(resizableVariants({ align: mergedOptions.align }), className)}
    />
  );
}

export const ResizableProvider = ResizablePrimitiveProvider;
